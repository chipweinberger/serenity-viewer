...
import 'package:serenity_viewer/src/environment/document/document_normalizer.dart';
import 'package:serenity_viewer/src/environment/document/document_data.dart';
import 'package:serenity_viewer/src/environment/workspace.dart';

Uint8List encodeDocumentBytes({
...
DocumentData decodeDocumentBytes(List<int> bytes) {
  ...
  final decodedEnvironment = normalizeDecodedEnvironment(Environment.fromManifestJson(manifestJson, workspaces));

  return DocumentData(environment: decodedEnvironment, thumbnailBytesByWorkspaceId: thumbnailBytesByWorkspaceId);
}
