...
Size importedWindowSize({
  ...
  if (importType == AssetType.video) {
    ...
    return WorkspaceLayout.windowSizeByFittingAspect(
...
Offset importedWindowPosition({required Offset viewportCenter, required int offsetIndex, required Size windowSize}) {
  return WorkspaceLayout.clampWindowPosition(
