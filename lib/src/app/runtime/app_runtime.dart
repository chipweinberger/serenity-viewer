...
class AppRuntime {
  ...
  static AppRuntime create(AppRuntimeInputs inputs) {
    ...
    workspace = createAppWorkspaceServices(
      ...
      envState: stateStore.environmentStoreState,
      uiState: stateStore.appUiState,
      interactionState: stateStore.windowInteractionState,
      trackingState: stateStore.workspaceViewTrackingState,
      viewportState: stateStore.workspaceViewportState,
      thumbState: stateStore.thumbnailRefreshState,
